 ...
 * 
 */
@WebServiceClient(name = "servicio", targetNamespace = "http://servicio/", wsdlLocation = "http://localhost:8084/ServicioWeb/servicio?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIO_QNAME = new QName("http://servicio/", "servicio");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/ServicioWeb/servicio?wsdl");
    ...
    public Servicio getServicioPort() {
        return super.getPort(new QName("http://servicio/", "servicioPort"), Servicio.class);
    }
    ...
    public Servicio getServicioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio/", "servicioPort"), Servicio.class, features);
    }
